    ...
    <header>
      ...
      <div class="main-content-header">
        <form method="post" action="result.php">
          <table class="table">
          <img src="dataimg/log.png"<?php  echo $data['u_image']; ?> class="image2" /> 
              <tr>
              <th>Name :</th>
          ...
          <table class="table2">
             ...
             <h1>You  are <span class="colorchange1"><?php 
                      ...
                      ?></span></h1>
            <marquee scrollamount="3"><p>Result Displayed!!Result Displayed!!Result Displayed!!Result Displayed!! Result Displayed!! Result Displayed!! Result Displayed!! Result Displayed!!</p>
                </marquee>
       </form>
      </div>
    </header>
